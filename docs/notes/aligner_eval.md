...
Alignment quality is risk #1 in the register: with 78 h in hand, it is the top quality lever
...
- **Wall-clock per song** on the rig. 78 h of corpus makes throughput a real constraint,
  not a footnote.
