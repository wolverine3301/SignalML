...
`overfit_v1` — 3 singers, 873 clips, 1.78 h, prod profile. Rebuilt on the rig from a
...
- Ship the rest of the corpus (`rig01`, 6.42 GB planned and hash-cached) and run
  `full_acoustic_v2` — 49 singers, 9.9 h, the first real multi-singer run.
